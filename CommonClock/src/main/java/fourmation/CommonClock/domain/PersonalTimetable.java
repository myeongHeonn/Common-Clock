...
public class PersonalTimetable {
    ...
    @Builder
    public PersonalTimetable(String name, Team team, boolean[] monday, boolean[] tuesday, boolean[] wednesday, boolean[] thursday, boolean[] friday, boolean[] saturday, boolean[] sunday) {
        this.name = name;
        this.team = team;
